...
const Detailed = (props) => {
  ...
  const removeCode = (content) => {
    return content.replace(/(<\/?code>)/g, '')
  }
  renderer.heading = function (text1, level, raw) {
    // removeCode(text1)
    const text = removeCode(text1)
    // const level = removeCode(level1)
